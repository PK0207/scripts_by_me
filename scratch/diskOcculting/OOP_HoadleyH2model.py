...
class H2Model(CircumstellarDisk):
    ...
    mmw_H2 = 2.33 * 1.67e-24 #below, Jl is the initial J, Ju is the upper level after pumping, and Jf is the lower/final level after fluorescence (Jf seems to be unused, manually added ones may be inaccurate)
    lambda_props = pd.DataFrame({"Wavelength": np.array([1338.56, 1342.26, 1393.96, 1398.95, 1402.65, 1431.01, 1446.12, 1460.17, 1463.83, 1467.08, 1489.57, 1500.45, 1504.76, 1521.59, 1524.65, 1556.87, 1580.67]).astype(np.float64),
                                 "Aul": np.array([       3.1E8,   2.8E8,   1.6E8,   2.6E8,   2.3E8,   1.0E8,   1.4E8,   1.5E8,   1.4E8,   1.3E8,   1.6E8,   1.7E8,   2.0E8,   6.0E8,   1.9E8,   1.2E8,   1.1E8]).astype(np.float64),
                                 "Jl": np.array([        0,       1,       1,       0,       1,       5,       5,       0,       1,       6,       5,       6,       5,       0,       6,       6,       6]).astype(np.float64),
                                 "Ju": np.array([        1,       2,       2,       1,       2,       4,       4,       1,       2,       7,       4,       7,       4,       1,       7,       7,       7]).astype(np.float64),
                                 "Jf": np.array([        2,       3,       1,       2,       3,       3,       5,       2,       3,       8,       3,       6,       5,       2,       8,       8,       8]).astype(np.float64),
                                 "Aul_total": np.array([ 1.8E9,   1.8E9,   1.8E9,   1.8E9,   1.8E9,   1.7E9,   1.7E9,   1.8E9,   1.8E9,   1.7E9,   1.7E9,   1.7E9,   1.7E9,   1.8E9,   1.7E9,   1.7E9,   1.7E9]).astype(np.float64)})
